...
public class LockableResource extends AbstractDescribableImpl<LockableResource> {
	...
	/** Boolean variable used to verify if resources are generated automatically */
	...
	/**
	 * @return True if this resource has been automatically generated, or false otherwise
	 */
	 ...
	 */
	public synchronized void updateReservedForNodesSet() {
