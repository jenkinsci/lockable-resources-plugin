...
public class LockableResourcesManager extends GlobalConfiguration {
	 ...
	 * meet the size criteria (there are not enough resources available, or the
	 * project has other items waiting, the method will return null.
	 * The method first finds available resources, and then queues them for the
