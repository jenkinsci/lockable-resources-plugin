...
public class RequiredResourcesProperty extends JobProperty<Job<?, ?>> {
	...
	/* The names of the global resources used */
	private final String resourceNames;
	/* The name of the variable that will hold the resources */
	private final String resourceNamesVar;
	/* The number of requested resources */
	private final String resourceNumber;
	/* The label associated with the requested resources */
	...
	/**
	 * @return An array of resources names generated by splitting the 'resourcesNames'
	 * field between white spaces
	 */
	...
	/**
	 * @return A string with the names of all the requested resources
	 */
	...
	/**
	 * @return The name of the variable that will store the reserved resources
	 */
	...
	/**
	 * @return A string containing the label associated with the resources requested
	 */
		...
		public FormValidation doCheckResourceNames(@QueryParameter String value,
			...
			if (names == null) {
				...
				if (wrongNames.isEmpty()) {
					...
					return FormValidation.error("The following resources do not exist: "
									+ wrongNames);
				}
			}
		}
		...
		public FormValidation doCheckLabelName(
			...
			if (label == null) {
				...
				if (LockableResourcesManager.get().isValidLabel(label)) {
					...
					return FormValidation.error("The label does not exist: " + label);
				}
			}
		}
