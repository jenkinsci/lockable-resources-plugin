...
public class RequiredResources extends AbstractDescribableImpl<RequiredResources> implements ExtensionPoint {
	...
	public RequiredResources(String resourceNames,
